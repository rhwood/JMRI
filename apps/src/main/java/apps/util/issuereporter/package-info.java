 ...
 * {@link apps.util.issuereporter.GitHubRepository} and register your
 * implementation as a service provider for that interface (see
 * {@link java.util.ServiceLoader} for details).
 */
@edu.umd.cs.findbugs.annotations.DefaultAnnotation(javax.annotation.CheckReturnValue.class)
