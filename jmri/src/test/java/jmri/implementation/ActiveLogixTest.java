...
public class ActiveLogixTest {
    ...
    public static void setUp() throws Exception {
        ...
        //InstanceManager.setDefault(jmri.jmrit.entryexit.EntryExitPairs.class,
        //                          new jmri.jmrit.entryexit.EntryExitPairs());
        //InstanceManager.setDefault(jmri.implementation.SignalSpeedMap.class,
