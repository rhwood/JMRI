...
public class ImageIndexEditorTest {
    ...
    public void testShow() {
        ...
        List<Runnable> tasks = sdm.getRunnables().stream().collect(Collectors.toList());
        List<SwingShutDownTask> swingTasks = tasks.stream().filter(t -> t instanceof SwingShutDownTask).map(t-> (SwingShutDownTask) t).collect(Collectors.toList());
