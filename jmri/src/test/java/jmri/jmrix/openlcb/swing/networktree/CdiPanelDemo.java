...
public class CdiPanelDemo {
    ...
    public void testDisplaySample1() {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        JFrame f = makeFrameFromFile("src/test/java/jmrix/openlcb/sample1.xml");
    ...
    public void testDisplaySample2() {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        JFrame f = makeFrameFromFile("src/test/java/jmrix/openlcb/sample2.xml");
    ...
    public void testLocoCdiDisplay() {
        Assume.assumeFalse(GraphicsEnvironment.isHeadless());
        JFrame f = makeFrameFromFile("src/test/java/jmrix/openlcb/NMRAnetDatabaseTrainNode.xml");
