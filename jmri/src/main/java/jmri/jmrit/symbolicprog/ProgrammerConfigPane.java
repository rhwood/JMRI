...
public class ProgrammerConfigPane extends JPanel implements PreferencesPanel {
    ...
    public ProgrammerConfigPane() {
        ...
        advancedPanel.add(showEmptyTabs = new JCheckBox(Bundle.getMessage("ProgShowEmptyTabs")));
        ...
        advancedPanel.add(showCvNums = new JCheckBox(Bundle.getMessage("ProgShowCVInTips")));
        ...
        advancedPanel.add(canCacheDefault = new JCheckBox(Bundle.getMessage("ProgCanCacheDefault")));
        ...
        advancedPanel.add(doConfirmRead = new JCheckBox(Bundle.getMessage("ProgDoConfirmRead")));
    ...
    public String getPreferencesItemText() {
        return Bundle.getMessage("MenuRoster"); // NOI18N
    }

    @Override
    public String getTabbedPreferencesTitle() {
        return Bundle.getMessage("TabbedLayoutProgrammer"); // NOI18N
    }

    @Override
    public String getLabelKey() {
        return Bundle.getMessage("LabelTabbedLayoutProgrammer"); // NOI18N
    }
