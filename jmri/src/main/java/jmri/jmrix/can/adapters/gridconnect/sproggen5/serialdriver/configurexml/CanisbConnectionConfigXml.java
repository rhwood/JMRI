 ...
 */
public class CanisbConnectionConfigXml extends AbstractSerialConnectionConfigXml {

    public CanisbConnectionConfigXml() {
        super();
    }
    ...
    protected void getInstance(Object object) {
        adapter = ((CanisbConnectionConfig) object).getAdapter();
    }

    @Override
    protected void register() {
        this.register(new CanisbConnectionConfig(adapter));
    }
