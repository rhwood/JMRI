 ...
 */
public class Sprog3PlusConnectionConfigXml extends AbstractSerialConnectionConfigXml {

    public Sprog3PlusConnectionConfigXml() {
        super();
    }
    ...
    protected void getInstance(Object object) {
        adapter = ((Sprog3PlusConnectionConfig) object).getAdapter();
    }

    @Override
    protected void register() {
        this.register(new Sprog3PlusConnectionConfig(adapter));
    }
