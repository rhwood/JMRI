...
public class SpecificSystemConnectionMemo extends jmri.jmrix.powerline.SerialSystemConnectionMemo {
    ...
    public void configureManagers() {
        setLightManager(new jmri.jmrix.powerline.cm11.SpecificLightManager(getTrafficController()));
        InstanceManager.setLightManager(getLightManager());
        setSensorManager(new jmri.jmrix.powerline.cm11.SpecificSensorManager(getTrafficController()));
