 ...
 * @since 3.3.1
 */
public class Bundle extends jmri.jmrix.ieee802154.Bundle {

    @CheckForNull
    private static final String name = "jmri.jmrix.ieee802154.swing.nodeconfig.NodeConfigBundle"; // NOI18N
