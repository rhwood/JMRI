 ...
 */
public class CanisbConnectionConfig extends jmri.jmrix.can.adapters.ConnectionConfig {
     ...
     */
    public CanisbConnectionConfig(jmri.jmrix.SerialPortAdapter p) {
        super(p);
    }
     ...
     */
    public CanisbConnectionConfig() {
        super();
    }

    @Override
    public String name() {
        return Bundle.getMessage("CanisbTitle");
    }
